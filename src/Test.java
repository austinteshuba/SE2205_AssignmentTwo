public class Test{
  ...
  public static void p3(){
	    QueueSimulator qS = new QueueSimulator(9,0.1,10);
	    double sT = qS.runSimulation();
	    
	    System.out.println();
	    System.out.println("Simulated for 10s with Arrival Rate of 1 packets/sec and Service Rate of 10 packets/sec:");
	    System.out.println("Sojourn time is "+sT+" seconds");
	    System.out.println();
